...
import (
	...
	"github.com/QEasyWeb3/QEasyChain/crypto/signify"
	"github.com/QEasyWeb3/QEasyChain/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/QEasyWeb3/QEasyChain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/QEasyWeb3/QEasyChain/mobile")
