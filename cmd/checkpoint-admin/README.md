...
the [source code](https://github.com/QEasyWeb3/QEasyChain/blob/master/params/config.go#L38) of the go-ethereum project.
...
```shell
go get github.com/QEasyWeb3/QEasyChain/cmd/checkpoint-admin
```
...
this [calculation method](https://github.com/QEasyWeb3/QEasyChain/blob/master/params/config.go#L251).*
