...
Clef [External API Spec](https://github.com/QEasyWeb3/QEasyChain/tree/master/cmd/clef#external-api-1) and
the [External API Changelog](https://github.com/QEasyWeb3/QEasyChain/blob/master/cmd/clef/extapi_changelog.md).
...
an [Internal API](https://github.com/QEasyWeb3/QEasyChain/tree/master/cmd/clef#ui-api-1) too for the UI (User Interface)
...
the [rules spec](https://github.com/QEasyWeb3/QEasyChain/blob/master/cmd/clef/rules.md).
