...
Please see [Releases](https://github.com/QEasyWeb3/QEasyChain/releases). We recommend using
the [most recently released version](https://github.com/QEasyWeb3/QEasyChain/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/QEasyWeb3/QEasyChain/tree/master/docs/audits

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `geth` | 20170425 | [pdf](https://github.com/QEasyWeb3/QEasyChain/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/QEasyWeb3/QEasyChain/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
| `Discv5` | 20191015 | [pdf](https://github.com/QEasyWeb3/QEasyChain/blob/master/docs/audits/2019-10-15_Discv5_audit_LeastAuthority.pdf) |
| `Discv5` | 20200124 | [pdf](https://github.com/QEasyWeb3/QEasyChain/blob/master/docs/audits/2020-01-24_DiscV5_audit_Cure53.pdf) |
...
the [disclosure page](https://github.com/QEasyWeb3/QEasyChain/security/advisories?state=published) for more information
about publically disclosed security vulnerabilities.
...
latest [`vulnerabilities.json`](https://geth.ethereum.org/docs/vulnerabilities/vulnerabilities.json) file which contains
known security vulnerabilities concerning `geth`, and cross-check the data against its own version number.
