...
- 2021-08-24: Released [v1.10.8](https://github.com/QEasyWeb3/QEasyChain/releases/tag/v1.10.8) containing the fix on
...
- Place the fix into the PR optimizing the jumpdest
  analysis [233381](https://github.com/QEasyWeb3/QEasyChain/pull/23381).
