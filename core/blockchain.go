...
import (
	...
	"github.com/QEasyWeb3/QEasyChain/core/state/snapshot"
	...
	"github.com/QEasyWeb3/QEasyChain/internal/syncx"
	...
	if isNeedReorg == NotSure {
		...
		if !reorg && externTd.Cmp(localTd) == 0 {
			...
			if block.NumberU64() < currentBlock.NumberU64() {
				...
				// Mainly for democracy engine, we use a more certainty rule to select a canonical chain, which is:
