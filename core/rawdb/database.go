...
import (
	...
	"github.com/QEasyWeb3/QEasyChain/ethdb/leveldb"
	"github.com/QEasyWeb3/QEasyChain/ethdb/memorydb"
...
func InspectDatabase(db ethdb.Database, keyPrefix, keyStart []byte) error {
	...
	for it.Next() {
		...
		case bytes.HasPrefix(key, []byte("democracy-")) && len(key) == 7+common.HashLength:
			democracySnaps.Add(size)
	...
	stats := [][]string{
		...
		{"Key-Value store", "Democracy snapshots", democracySnaps.Size(), democracySnaps.Count()},
