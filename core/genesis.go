...
func SetupGenesisBlockWithOverride(db ethdb.Database, genesis *Genesis, overrideArrowGlacier *big.Int) (*params.ChainConfig, common.Hash, error) {
	...
	// Check whether consensus config of Democracy is changed
	if !storedcfg.IsDemocracyCompatible(newcfg) {
		return nil, common.Hash{}, errors.New("DemocracyConfig is not compatiable with stored")
	}
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	default:
		return params.AllDemocracyProtocolChanges
	}
}
