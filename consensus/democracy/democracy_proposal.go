...
func (c *Democracy) processProposalTx(chain consensus.ChainHeaderReader, header *types.Header,
...
func (c *Democracy) getPassedProposalCount(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB) (uint32, error) {
...
func (c *Democracy) getPassedProposalByIndex(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, idx uint32) (*systemcontract.Proposal, error) {
...
//finishProposalById
func (c *Democracy) finishProposalById(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, id *big.Int) error {
...
func (c *Democracy) executeProposal(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, prop *systemcontract.Proposal, totalTxIndex int) (*types.Transaction, *types.Receipt, error) {
...
func (c *Democracy) replayProposal(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, prop *systemcontract.Proposal, totalTxIndex int, tx *types.Transaction) (*types.Receipt, error) {
...
func (c *Democracy) executeProposalMsg(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, prop *systemcontract.Proposal, totalTxIndex int, txHash, bHash common.Hash) *types.Receipt {
...
func (c *Democracy) IsSysTransaction(sender common.Address, tx *types.Transaction, header *types.Header) bool {
	if tx.To() == nil {
		return false
	}
	to := tx.To()
	...
	if sender == header.Coinbase {
		contract := system.GetContractAddressByConfig(system.OnChainDaoContractName, header.Number, c.chainConfig)
		if *to == contract {
			return true
		}
	}
...
func (c *Democracy) ApplyProposalTx(evm *vm.EVM, state *state.StateDB, txIndex int, sender common.Address, tx *types.Transaction) (ret []byte, vmerr error, err error) {
