...
func (c *Democracy) punishDoubleSign(chain consensus.ChainHeaderReader, header *types.Header,
...
func (c *Democracy) AttestationStatus() uint8 {
	return c.attestationStatus
}

func (c *Democracy) StartAttestation() {
	c.attestationStatus = types.AttestationStart
}

func (c *Democracy) StopAttestation() {
	c.attestationStatus = types.AttestationStop
}

func (c *Democracy) ClearAllViolateCasperFFGPunish() {
...
func (c *Democracy) VerifyAttestation(chain consensus.ChainHeaderReader, a *types.Attestation) (common.Address, int, error) {
...
func (c *Democracy) CurrentValidator() common.Address {
	return c.validator
}
...
func (c *Democracy) makeNewAttestation(sourceRangeEdge *types.RangeEdge, targetRangeEdge *types.RangeEdge) (*types.Attestation, error) {
...
func (c *Democracy) IsAuthorizedAtHeightAndHash(chain consensus.ChainHeaderReader, val common.Address, hash common.Hash, number uint64) bool {
	h := chain.GetHeader(hash, number)
	return c.IsAuthorizedByHeader(chain, val, h)
}

func (c *Democracy) IsAuthorizedAtHeight(chain consensus.ChainHeaderReader, val common.Address, height uint64) bool {
	h := chain.GetHeaderByNumber(height)
	return c.IsAuthorizedByHeader(chain, val, h)
}

func (c *Democracy) IsAuthorizedByHeader(chain consensus.ChainHeaderReader, val common.Address, h *types.Header) bool {
	if h == nil {
...
func (c *Democracy) CurrentNeedHandleHeight(headerNum uint64) (uint64, error) {
...
func (c *Democracy) AttestationDelay() uint64 {
...
func (c *Democracy) Validators(chain consensus.ChainHeaderReader, hash common.Hash, number uint64) ([]common.Address, error) {
	header := chain.GetHeader(hash, number)
	if header == nil {
...
func (c *Democracy) VerifyCasperFFGRule(beforeSourceNum uint64, beforeTargetNum uint64, afterSourceNum uint64, afterTargetNum uint64) int {
...
func (c *Democracy) executeDoubleSignPunish(chain consensus.ChainHeaderReader, header *types.Header,
...
func (c *Democracy) replayDoubleSignPunish(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, totalTxIndex int, tx *types.Transaction) (*types.Receipt, error) {
...
func (c *Democracy) IsDoubleSignPunished(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, punishHash common.Hash) (bool, error) {
...
func (c *Democracy) executeDoubleSignPunishMsg(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, p *types.ViolateCasperFFGPunish, totalTxIndex int, txHash, bHash common.Hash) (*types.Receipt, error) {
...
func (c *Democracy) ApplyDoubleSignPunishTx(evm *vm.EVM, sender common.Address, tx *types.Transaction) (ret []byte, vmerr error, err error) {
